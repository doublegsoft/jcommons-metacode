...
public class ExtensionUnderlineTest extends TestBase {
  ...
  private ModelDefinition buildDataModel() {
    ...
    simpleEx.setLabelledOption("extension", "master", "simple");
    simpleEx.setLabelledOption("extension", "details", "");
    return retVal;
  }
  ...
  public void test() throws Exception {
    ...
    ObjectDefinition simpleEx = dataModel.findObjectByName("simple_");
    TypeDefinition type = new TypeDefinition(simpleEx, dataModel);
