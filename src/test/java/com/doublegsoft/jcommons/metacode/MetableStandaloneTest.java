...
public class MetableStandaloneTest extends TestBase {
  ...
  private ModelDefinition buildDataModel() {
    ...
    metableEx.setLabelledOption("meta", "key", "property_name");
    metableEx.setLabelledOption("meta", "value", "property_value");
    return retVal;
  }
  ...
  public void test() throws Exception {
    ...
    ObjectDefinition metableEx = dataModel.findObjectByName("metable_full");
